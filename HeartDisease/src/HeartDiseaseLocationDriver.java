...
public class HeartDiseaseLocationDriver {
    public static void main(String[] args) throws Exception {
        ...
        jobConf.setMapperClass(HeartDiseaseLocationMapper.class);
        jobConf.setReducerClass(HeartDiseaseLocationReducer.class);
