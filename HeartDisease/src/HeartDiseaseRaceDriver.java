...
public class HeartDiseaseRaceDriver {
    public static void main(String[] args) throws Exception {
        JobClient myClient = new JobClient();
        // Create a configuration object for the job
        JobConf jobConf = new JobConf(HeartDiseaseRaceDriver.class);
        ...
        jobConf.setMapperClass(HeartDiseaseRaceMapper.class);
        jobConf.setReducerClass(HeartDiseaseRaceReducer.class);
